...
from tariff.models import Finance, HsCode
        ...
        with open(csv_file_path, mode='r', encoding='utf-8') as file:
            ...
            for row in reader:
                ...
                try:
                    ...
                    if created:
                        self.stdout.write(self.style.SUCCESS(f'Successfully added sub chapter: {finance.finance}'))
                    else:
                        self.stdout.write(self.style.WARNING(f'Sub chapter {finance.finance} already exists.'))
