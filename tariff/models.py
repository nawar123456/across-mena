...
class HsCode(models.Model):
    ...
    checking=models.BooleanField(default=False, null=False, blank=True)
    new=models.BooleanField(default=False, null=False, blank=True)
    ...
    review_en= models.CharField(max_length=512, null=True, blank=True)
    review_value = models.CharField(max_length=2, null=True, blank=True)
    import_fee = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True,verbose_name='Price Import')  # ✅ Numbers only
    export_fee = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name='Clearance Fee Export')  # ✅ Numbers only
    ...
    exp_se_Fe= models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True,verbose_name='Price Export')
    ...
    image = models.FileField(upload_to='media/items/images',null=True,blank=True)
    def save(self, *args, **kwargs):
        import_fee = float(self.import_fee or 0)
        ser_all = float(self.ser_all or 0)
        self.full_import_fee = import_fee + ser_all
